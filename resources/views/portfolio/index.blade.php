...
@section('content')
{{-- ===================== HERO ===================== --}}{{-- ===================== HERO ===================== --}}
<header class="relative min-h-screen flex items-center overflow-hidden bg-[#0a0a1f] text-white">
    ...
    <div class="absolute inset-0">
        ...
        {{-- Dark overlay --}}
        <div class="absolute inset-0 bg-gradient-to-r from-[#0a0a1f]/95 via-[#0a0a1f]/75 to-[#0a0a1f]/85"></div>
        <div class="absolute inset-0 bg-gradient-to-t from-[#0a0a1f]/95 via-transparent to-[#0a0a1f]/30"></div>
    </div>

    {{-- Nebula glow effects --}}
    <div class="absolute inset-0 bg-[radial-gradient(at_center,#1e3a8a_0%,transparent_70%)] opacity-40"></div>
    <div class="absolute top-[-100px] right-[-80px] w-[600px] h-[600px] bg-cyan-400 rounded-full blur-[140px] opacity-20"></div>
    <div class="absolute bottom-[-150px] left-[-100px] w-[500px] h-[500px] bg-indigo-500 rounded-full blur-[130px] opacity-15"></div>
    ...
    <div class="container mx-auto px-6 lg:px-8 relative z-10 pt-24 pb-16">
        <div class="grid lg:grid-cols-12 gap-[110px] items-center">
            ...
            <div class="lg:col-span-6 space-y-8">
                <div class="inline-flex items-center gap-2.5 px-5 py-2.5 text-sm font-medium text-emerald-400 bg-emerald-950/60 border border-emerald-900/50 rounded-full">
                ...
                <h1 class="text-5xl lg:text-5xl font-semibold leading-[1.05] tracking-tighter">
                    I'm <span class="text-white">{{ config('portfolio.name') ?? 'John' }}</span>,<br>
                    a <span class="bg-gradient-to-r from-cyan-400 via-blue-400 to-indigo-400 bg-clip-text text-transparent">Web Developer</span>
                </h1>
                ...
                <div class="flex flex-wrap gap-4">
                    ...
                    <a href="#contact"
                       class="inline-flex items-center gap-2 px-8 py-4 text-sm font-semibold text-gray-200 border border-white/30 hover:border-cyan-400 rounded-full transition-all">
                        Contact Me
                    </a>
                </div>
            </div>
            ...
            <div class="lg:col-span-6 space-y-10 lg:pl-12">
                ...
                <div class="pt-8 flex items-center gap-6">
                    <span class="text-sm uppercase tracking-widest text-gray-400">Follow Me</span>
                    <div class="flex gap-5 text-2xl text-gray-400">
                        ...
                        <a href="#" class="hover:text-white transition-colors">▶︎</a>
                    </div>
                </div>
            </div>
        </div>
...
{{-- ===================== ABOUT ===================== --}}
<section id="about" class="section py-12 bg-[#0a0a1f] text-white relative overflow-hidden">

    {{-- نفس جو الـ Hero: dot-grid خفيف + توهجات --}}
    <div class="absolute inset-0 opacity-[0.15] [background-image:radial-gradient(circle,#334155_1px,transparent_1px)] [background-size:28px_28px] pointer-events-none"></div>
    <div class="absolute top-[-120px] left-[-100px] w-[420px] h-[420px] bg-indigo-600 rounded-full blur-[130px] opacity-15 pointer-events-none"></div>
    <div class="absolute bottom-[-140px] right-[-100px] w-[420px] h-[420px] bg-cyan-500 rounded-full blur-[120px] opacity-10 pointer-events-none"></div>
        ...
        <div class="about-grid grid lg:grid-cols-12 gap-16 lg:gap-20 items-center">
            ...
            <div class="about-photo reveal lg:col-span-5 flex justify-center lg:justify-end">
                <div class="relative max-w-xs lg:max-w-md w-full">
                    ...
                    <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-80 h-80 bg-gradient-to-br from-cyan-400 to-indigo-600 rounded-full blur-[90px] opacity-25 pointer-events-none"></div>

                    <div class="relative">
                        <img
                            src="{{ asset('images/osama.jpg') }}"
                            alt="{{ config('portfolio.name') }}"
                            class="relative z-10 w-full aspect-square object-contain drop-shadow-[0_25px_35px_rgba(0,0,0,0.5)] transition-transform duration-1000 hover:scale-[1.03]"
                            onerror="this.style.display='none'">

                        {{-- Trial-balance styled stat card, floating off the photo --}}
                        <div class="absolute -bottom-8 -right-6 lg:-right-10 z-20 w-52 bg-gray-900/90 backdrop-blur-md rounded-2xl shadow-xl border border-white/10 p-5">
                            <div class="flex items-center justify-between pb-3 mb-3 border-b border-dashed border-white/15">
                                <span class="font-mono text-[10px] tracking-[2px] text-gray-400">TRIAL BALANCE</span>
                                <span class="font-mono text-[10px] text-emerald-400">✓ OK</span>
                            </div>
                            <div class="space-y-2.5">
                                <div class="flex items-baseline justify-between">
                                    <span class="text-xs text-gray-400">Query time</span>
                                    <span class="font-mono text-sm font-semibold text-white">-75%</span>
                                </div>
                                <div class="flex items-baseline justify-between">
                                    <span class="text-xs text-gray-400">Users served</span>
                                    <span class="font-mono text-sm font-semibold text-white">25K+</span>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="about-text reveal lg:col-span-7 space-y-10 lg:pb-8">
                ...
                <div class="flex items-center gap-4">
                    <span class="eyebrow px-7 py-3 text-sm font-mono tracking-[3px] text-cyan-400 bg-white/5 backdrop-blur shadow border border-cyan-900/50 rounded-3xl">
                        ABOUT ME
                    </span>
                    <div class="h-px flex-1 bg-gradient-to-r from-cyan-800 to-transparent"></div>
                </div>

                <h3 class="text-5xl lg:text-6xl font-semibold leading-[1.1] tracking-tighter text-white">
                    Hi, I'm
                    <span class="bg-gradient-to-r from-cyan-400 to-indigo-400 bg-clip-text text-transparent">{{ config('portfolio.name') }}</span>
                    👋
                </h3>

                <div class="max-w-2xl space-y-7 text-[17.5px] leading-relaxed text-gray-300">
                    <p class="font-light">
                        Backend-focused full-stack engineer with deep expertise in <strong class="font-semibold text-white">Laravel</strong> and modern PHP ecosystem.
                ...
                <div class="pills grid grid-cols-1 sm:grid-cols-2 gap-3 pt-4">
                    <div class="flex items-center gap-3 px-5 py-4 bg-white/5 border border-white/10 rounded-2xl backdrop-blur transition-all duration-300 hover:border-cyan-500/40 hover:bg-white/[0.07]">
                        <span class="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-indigo-950/60 text-lg">🏦</span>
                        <span class="text-sm font-medium text-gray-200">Fintech &amp; Ledgers</span>
                    </div>
                    <div class="flex items-center gap-3 px-5 py-4 bg-white/5 border border-white/10 rounded-2xl backdrop-blur transition-all duration-300 hover:border-cyan-500/40 hover:bg-white/[0.07]">
                        <span class="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-amber-950/60 text-lg">⚡</span>
                        <span class="text-sm font-medium text-gray-200">Performance Tuning</span>
                    </div>
                    <div class="flex items-center gap-3 px-5 py-4 bg-white/5 border border-white/10 rounded-2xl backdrop-blur transition-all duration-300 hover:border-cyan-500/40 hover:bg-white/[0.07]">
                        <span class="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-rose-950/60 text-lg">🔐</span>
                        <span class="text-sm font-medium text-gray-200">Secure Systems</span>
                    </div>
                    <div class="flex items-center gap-3 px-5 py-4 bg-white/5 border border-white/10 rounded-2xl backdrop-blur transition-all duration-300 hover:border-cyan-500/40 hover:bg-white/[0.07]">
                        <span class="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-emerald-950/60 text-lg">🏗️</span>
                        <span class="text-sm font-medium text-gray-200">Clean Architecture</span>
                    </div>
                    <div class="flex items-center gap-3 px-5 py-4 bg-white/5 border border-white/10 rounded-2xl backdrop-blur transition-all duration-300 hover:border-cyan-500/40 hover:bg-white/[0.07] sm:col-span-2">
                        <span class="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-sky-950/60 text-lg">📡</span>
                        <span class="text-sm font-medium text-gray-200">Real-time &amp; WebSocket</span>
                    </div>
                </div>
...
{{-- ===================== PROJECTS ===================== --}}
<section id="projects" class="py-24 relative overflow-hidden px-auto" 
         style="background: #0a0a1f;">
    
    {{-- Background glow effects --}}
    <div class="absolute inset-0 bg-[radial-gradient(at_center,#1e3a8a_0%,transparent_60%)] opacity-30"></div>
    ...
    <div class="container mx-auto px-6 lg:px-8 relative z-10">
        ...
        <div class="sec-head text-center max-w-2xl mx-auto mb-16 reveal">
            <span class="inline-block px-5 py-2 text-sm font-medium tracking-widest text-cyan-400 bg-cyan-950/50 border border-cyan-900/50 rounded-full mb-4">
                // SELECTED WORK
            </span>
            <h2 class="text-5xl lg:text-6xl font-semibold tracking-tighter text-white mb-4">
                Projects &amp; Platforms
            </h2>
    ...
    <button class="carousel-btn prev absolute -left-4 lg:-left-6 top-1/2 -translate-y-1/2 z-30 w-12 h-12 flex items-center justify-center 
                   bg-[#0f172a]/90 hover:bg-cyan-950 border border-cyan-400/30 hover:border-cyan-400 
                   text-cyan-400 hover:text-white rounded-full text-4xl transition-all duration-300 shadow-xl"
            data-prev aria-label="Previous project">
        ‹
    </button>

    <div class="carousel-viewport overflow-hidden rounded-3xl border border-white/5 bg-[#0f172a]/70 backdrop-blur-md">
                ...
                <article class="slide min-w-full px-8 py-10 lg:p-12 flex flex-col lg:flex-row gap-10 lg:gap-16 items-center">
                    ...
                    <div class="slide-media w-full lg:w-5/12 relative group">
                        @if($project->image_url)
                            <div class="aspect-video overflow-hidden rounded-2xl border border-cyan-900/30 shadow-2xl shadow-cyan-950/50">
                        ...
                        @else
                            <div class="aspect-video bg-gradient-to-br from-cyan-900/30 to-indigo-900/30 rounded-2xl flex items-center justify-center border border-cyan-900/30">
                                <span class="text-6xl text-cyan-400/30">{{ $project->category }}</span>
                            </div>
                        @endif
                    ...
                    <div class="slide-info w-full lg:w-7/12 space-y-6">
                        <span class="cat inline-block px-4 py-1 text-xs font-semibold tracking-widest uppercase bg-cyan-950 text-cyan-400 border border-cyan-800 rounded-lg">
                            {{ $project->category }}
                        </span>
                        
                        <h3 class="text-3xl font-semibold text-white tracking-tight leading-tight">
                            {{ $project->title }}
                        </h3>
                        
                        <p class="desc text-gray-300 text-[17px] leading-relaxed">
                            {{ $project->summary }}
                        </p>
                        ...
                        @if($project->tech_stack)
                            <div class="tags flex flex-wrap gap-2 pt-2">
                                @foreach(array_slice($project->tech_stack, 0, 6) as $tech)
                                    <span class="tag px-4 py-1.5 text-xs bg-white/5 hover:bg-cyan-950 border border-white/10 hover:border-cyan-700 rounded-xl text-gray-300 transition-colors">
                                        {{ $tech }}
                                    </span>
                                @endforeach
                            </div>
                        ...
                        <div class="slide-cta flex flex-wrap gap-4 pt-6">
                            ...
                            @if($project->url)
                                <a href="{{ $project->url }}" target="_blank" rel="noopener"
                                   class="btn btn-ghost inline-flex items-center gap-2 px-8 py-4 border border-white/20 hover:border-cyan-400 text-gray-200 hover:text-white rounded-2xl transition-all duration-300">
                                    Live site ↗
                                </a>
                            @endif
                        </div>
    ...
    <div class="carousel-dots flex justify-center gap-3 mt-10" data-dots>
        @foreach($projects as $i => $project)
            <button class="dot w-3 h-3 rounded-full bg-white/20 hover:bg-cyan-400 transition-all {{ $i === 0 ? 'active !bg-cyan-400 scale-125' : '' }}" 
                    data-dot="{{ $i }}"></button>
        @endforeach
    </div>
</div>
    ...
    <div class="container mx-auto px-6 lg:px-8 relative z-10">
        ...
        <div class="skills-grid grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            @foreach($skills as $category => $items)
                <div class="skill-group bg-[#0f172a]/70 backdrop-blur-md border border-white/5 rounded-3xl p-8 hover:border-cyan-900/50 transition-all duration-500 group">
                        ...
                        @foreach($items as $skill)
                            <div class="skill-row group/skill">
                                <div class="top flex justify-between items-baseline mb-2.5">
                                    ...
                                    <span class="pct text-cyan-400 font-mono text-sm font-semibold">
                                        {{ $skill->level }}%
                                    </span>
                                </div>
                                
                                <!-- Progress Bar -->
                                <div class="bar h-2.5 bg-white/5 rounded-2xl overflow-hidden border border-white/5">
    ...
    <div class="container mx-auto px-6 lg:px-8 relative z-10">
        ...
        <div class="timeline max-w-3xl mx-auto relative">
            ...
            <div id="timeline-line" 
                 class="absolute left-8 top-6 bottom-6 w-[3px] bg-gradient-to-b from-cyan-400/30 via-cyan-500/20 to-transparent origin-top scale-y-0 transition-transform duration-1000"></div>
            ...
            @foreach($experiences as $index => $exp)
                <div class="tl-item relative pl-20 pb-16 last:pb-0 group reveal"
                    ...
                    <!-- Node -->
                    <span class="node absolute left-6 top-2 w-5 h-5 rounded-full border-4 border-cyan-400 bg-[#0a0a1f] z-10 
                                 scale-0 transition-all duration-500 group-hover:scale-110"></span>
                    
                    <!-- Content Card -->
                    <div class="card bg-[#0f172a]/70 backdrop-blur-md border border-white/5 hover:border-cyan-900 rounded-3xl p-8 transition-all duration-700 hover:shadow-2xl hover:shadow-cyan-950/50 translate-x-8 opacity-0">
                        
                        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 mb-5">
                            <span class="period inline-block px-4 py-1.5 text-sm font-mono tracking-widest text-cyan-400 bg-cyan-950/50 border border-cyan-900/50 rounded-2xl">
                                {{ $exp->period }}
                            </span>
                            <span class="company text-gray-400 font-medium">{{ $exp->company }}</span>
                        </div>

                        <h4 class="text-2xl font-semibold text-white tracking-tight mb-4">
                            {{ $exp->role }}
                        </h4>
                        ...
                        @if($exp->highlights)
                            <ul class="space-y-3 text-gray-300">
                                @foreach($exp->highlights as $h)
                                    <li class="flex gap-3">
                                        <span class="text-cyan-400 mt-1.5 text-xl leading-none">›</span>
                                        <span>{{ $h }}</span>
                                    </li>
                                @endforeach
                            </ul>
...
<section id="testimonials" class="py-20 relative overflow-hidden" style="background: #0a0a1f;">
    ...
    <div class="container mx-auto px-6 lg:px-8 relative z-10">
        ...
        <div class="max-w-2xl reveal mb-16 lg:mb-20">
            <span class="inline-block px-6 py-2.5 text-sm font-medium tracking-widest text-cyan-400 bg-cyan-950/50 border border-cyan-900/50 rounded-full mb-6">
                // CLIENT REVIEWS
            </span>
            <h2 class="text-4xl lg:text-5xl font-semibold tracking-tighter text-white leading-tight">
                Read reviews,<br>
                <span class="text-cyan-400">hire with confidence.</span>
            </h2>
            ...
            <div class="flex items-center gap-3 mt-8">
                ...
                <span class="text-gray-400">Based on {{ $testimonials->count() }} reviews</span>
            </div>
        </div>
        ...
        <div class="grid lg:grid-cols-[280px_1fr] gap-10 lg:gap-16 items-start">
            ...
            <div class="reveal lg:sticky lg:top-32">
                <span class="block text-8xl leading-none text-cyan-400/20 font-serif mb-6">“</span>
                
                <h3 class="text-3xl font-semibold text-white mb-8 leading-tight">
                    What our customers are saying
                </h3>

                <div class="flex items-center gap-4" id="testimonial-controls">
                    <button onclick="prevTestimonial()" 
                            class="w-11 h-11 flex items-center justify-center rounded-2xl border border-cyan-900 hover:border-cyan-400 text-cyan-400 hover:text-white transition-all text-2xl">
                        ←
                    </button>

                    <div class="flex-1 h-px bg-white/10 relative overflow-hidden rounded-full">
            ...
            <div class="overflow-hidden" id="testimonial-carousel">
                <div class="flex gap-6 transition-transform duration-700 ease-out" id="testimonial-track" style="will-change: transform;">
                    @foreach($testimonials as $t)
                        <figure class="testimonial-card min-w-[300px] sm:min-w-[340px] bg-[#0f172a]/80 backdrop-blur-xl border border-white/5 hover:border-cyan-400/50 rounded-3xl p-8 flex flex-col transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl hover:shadow-cyan-500/10">
                            
                            <blockquote class="text-[15.5px] leading-relaxed text-gray-300 mb-10">
                                "{{ $t->body }}"
                            </blockquote>

                            <div class="stars flex text-lg text-emerald-400 mb-8 mt-auto">
                            ...
                            <figcaption class="flex items-center gap-4">
                                ...
                                <div>
                                    <strong class="block text-white">{{ $t->name }}</strong>
...
{{-- ===================== CONTACT ===================== --}}
<section id="contact" class="relative overflow-hidden " style="background: #132148;">

    {{-- Top dark hero with diagonal cut --}}
    <div class="relative  pt-12 pb-[150px]">
        <div class="max-w-3xl mx-auto text-center px-6">
            <h2 class="text-4xl md:text-5xl font-extrabold bg-gradient-to-r from-white to-slate-400 bg-clip-text text-transparent">
    ...
    <div class="relative bg-white py-20">
        ...
        <div class="absolute bottom-0 left-0 w-full h-24 bg-[#0a0e2e] [clip-path:polygon(0_0,100%_100%,0_100%)]"></div>
    </div>

    {{-- Bottom CTA banner --}}
    <div class="relative bg-gradient-to-br from-[#0a0e2e] via-[#0c1240] to-[#141a4d] pt-12 pb-12 text-center px-6">
        <span class="inline-flex items-center gap-2 rounded-full bg-white/10 text-slate-300 text-xs font-medium px-4 py-1.5">
            📣 We Ready 24 Hours
        </span>

        <h3 class="mt-6 text-3xl md:text-4xl font-extrabold">
            <span class="text-white">Have a project in mind?</span>
